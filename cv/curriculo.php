  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Danilo
            <span class="text-primary">Silva</span>
          </h1>
          <div class="subheading mb-5">Rua de Teste · Cheyenne Wells, CO 80810 · (317) 585-8468 ·
            <a href="mailto:name@email.com">nome@email.com</a>
          </div>
          <p class="mb-5">Tenho diversas experiências.</p>
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">Estudante de Desenvolvimento Web</h3>
              <div class="subheading mb-3">Fatec Taubaté</div>
              <p>Usar estratégias para rápido desenvolvimento, como templates.</p>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">Janeiro 2015 - Present</span>
            </div>
          </div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">Fatec Taubaté</h3>
              <div class="subheading mb-3">Cursando</div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
        <div class="my-auto">
          ...
          <p>Além de desenvolver Web, gosto de programação linear.</p>
        </div>
      </section>
